# Autogenerated wrapper script for PortAudio_jll for x86_64-apple-darwin14
export libportaudio
...
const libportaudio_splitpath = ["lib", "libportaudio.2.dylib"]
...
const libportaudio = "@rpath/libportaudio.2.dylib"
...
"""
function __init__()
    global artifact_dir = abspath(artifact"PortAudio")
