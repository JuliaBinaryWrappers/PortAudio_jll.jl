# Autogenerated wrapper script for PortAudio_jll for x86_64-w64-mingw32
export libportaudio
...
const libportaudio_splitpath = ["bin", "libportaudio-2.dll"]
...
const libportaudio = "libportaudio-2.dll"
